...
export METAMON_WANDB_PROJECT="${METAMON_WANDB_PROJECT:-metamon-plastic-tauros}"
export WANDB_MODE="${WANDB_MODE:-offline}"

SAVE_DIR="${SAVE_DIR:-/home/eddie/metamon/models/plastic_tauros_15m_sweep}"
EPOCHS="${EPOCHS:-6}"
STEPS_PER_EPOCH="${STEPS_PER_EPOCH:-25000}"
...
RUNS="${RUNS:-small-control small-damped small-damped-retention}"
...
run_one() {
  ...
  case "$run_name" in
    small-control)
      ...
      ;;
    small-damped)
      train_gin="plastic_tauros_15m_damped.gin"
      dataset_config="gen1ou_small_tauros_core.yaml"
      ;;
    small-damped-retention)
      train_gin="plastic_tauros_15m_damped.gin"
