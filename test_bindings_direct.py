"""
Direct test of engine bindings - imports the module file directly.
"""
...
# Load bindings module directly from file path
bindings_path = Path(__file__).parent / "metamon" / "engine" / "bindings.py"
spec = importlib.util.spec_from_file_location("engine_bindings", bindings_path)
